                    ...
                    <div classNameName="container-fluid px-0">
                        <div id="carouselId" classNameName="carousel slide" data-bs-ride="carousel">
                            <ol classNameName="carousel-indicators">
                                <li data-bs-target="#carouselId" data-bs-slide-to="0" classNameName="active" aria-current="true" aria-label="First slide"></li>
                                <li data-bs-target="#carouselId" data-bs-slide-to="1" aria-label="Second slide"></li>
                            </ol>
                            <div classNameName="carousel-inner" role="listbox">
                                <div classNameName="carousel-item active">
                                    <img src={carousel_Image1} classNameName="img-fluid" alt="First slide" />
                                    <div classNameName="carousel-caption">
                                        <div classNameName="container carousel-content">
                                            <h6 classNameName="text-secondary h4 animated fadeInUp">Best IT Solutions</h6>
                                            <h1 classNameName="text-white display-1 mb-4 animated fadeInRight">An Innovative IT Solutions Agency</h1>
                                            <p classNameName="mb-4 text-white fs-5 animated fadeInDown">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut interdum. Pellentesque aliquam dolor eget urna ultricies tincidunt.</p>
                                            <a href="" classNameName="me-2"><button type="button" classNameName="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn1 animated fadeInLeft">Read More</button></a>
                                            <a href="" classNameName="ms-2"><button type="button" classNameName="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn2 animated fadeInRight">Contact Us</button></a>
                                        </div>
                                    </div>
                                </div>
                                <div classNameName="carousel-item">
                                    <img src={carousel_image2} classNameName="img-fluid" alt="Second slide" />
                                    <div classNameName="carousel-caption">
                                        <div classNameName="container carousel-content">
                                            <h6 classNameName="text-secondary h4 animated fadeInUp">Best IT Solutions</h6>
                                            <h1 classNameName="text-white display-1 mb-4 animated fadeInLeft">Quality Digital Services You Really Need!</h1>
                                            <p classNameName="mb-4 text-white fs-5 animated fadeInDown">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut interdum. Pellentesque aliquam dolor eget urna ultricies tincidunt.</p>
                                            <a href="" classNameName="me-2"><button type="button" classNameName="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn1 animated fadeInLeft">Read More</button></a>
                                            <a href="" classNameName="ms-2"><button type="button" classNameName="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn2 animated fadeInRight">Contact Us</button></a>
                                        </div>
                            ...
                            <div className="row g-5">
                                <div className="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                                    <div className="h-100 position-relative">
                                        <img src={about_img1} className="img-fluid w-75 rounded" alt="" style={{ marginBottom: "25%" }} />
                                        <div className="position-absolute w-75" style={{ top: "25%", left: "25%" }}>
                                            <img src={about_img2} className="img-fluid w-100 rounded" alt="" />
                                        </div>
                                    </div>
                                </div>
